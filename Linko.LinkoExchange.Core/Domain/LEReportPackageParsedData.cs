...
namespace Linko.LinkoExchange.Core.Domain
{
    ...
    /// Represents a simple “flat” export format representing one LinkoExchange report package containing any number of report elements, 
    ///  but excluding samples and results.
    /// </summary>
    public partial class LEReportPackageParsedData
    {
        /// <summary>
        /// Primary key.
        /// </summary>
        ...
        /// <summary>
        /// A concatenated and ordered list of Parameter sampling that did not meet sampling frequency requirements that are in the Report Package.
        /// </summary>
