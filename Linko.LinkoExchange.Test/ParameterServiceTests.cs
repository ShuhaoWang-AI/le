...
namespace Linko.LinkoExchange.Test
{
    ...
    public class ParameterServiceTests
    {
        ...
        {
            var resultDtos = _paramService.GetAllParameterGroups(monitoringPointId:129, sampleDateTimeLocal:new DateTime(year:1997, month:3, day:31), collectionMethodId: 1);
        }
