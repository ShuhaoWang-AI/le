...
{
    [Validator(validatorType:typeof(UserProfileViewModelValidator))]
    public class UserProfileViewModel : PasswordViewModel
    {
        ...
        public bool HasSigntory { get; set; }

        [Editable(allowEdit:false)]
        [Display(Name = "Signatory")]
        public string HasSigntoryText => HasSigntory ? "Yes" : "No";
        ...
        public List<JurisdictionViewModel> StateList { get; set; }

        #endregion
    }

    public class UserProfileViewModelValidator : LinkExchangePasswordValidator<UserProfileViewModel>
    {
