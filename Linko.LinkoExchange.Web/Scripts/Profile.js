...
$(document).ready(function () {
    ...
    $(".box-primary").find("i.fa.fa-minus").removeClass('fa-minus');
    $(".box-primary").find("i.fa").addClass('fa-plus');

    if (profileCollapsed.toLowerCase() == 'false') {
        $("#user-info-panel .box-primary").removeClass("collapsed-box");
        $("#user-info-panel .box-primary").find("i.fa.fa-plus").removeClass('fa-plus');
        $("#user-info-panel .box-primary").find("i.fa").addClass('fa-minus');
    }
