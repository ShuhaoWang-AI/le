...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        less: {
            ...
            development: {
                ...
                files: {
                    ...
                    // Copy file to ../Linko.LinkoExchange.Web/Content/AdminLTE/
                    // compilation.css  :  source.less
                    "../Linko.LinkoExchange.Web/Content/AdminLTE/css/AdminLTE.css": "build/less/AdminLTE.less",
                    //Non minified skin files
                    "../Linko.LinkoExchange.Web/Content/AdminLTE/css/skins/skin-blue-light.css": "build/less/skins/skin-blue-light.less"
                }
            },
            ...
            production: {
                ...
                files: {
                    ...
                    // Copy file to ../Linko.LinkoExchange.Web/Content/AdminLTE/
                    // compilation.css  :  source.less
                    "../Linko.LinkoExchange.Web/Content/AdminLTE/css/AdminLTE.min.css": "build/less/AdminLTE.less",
                    //Non minified skin files
                    "../Linko.LinkoExchange.Web/Content/AdminLTE/css/skins/skin-blue-light.min.css": "build/less/skins/skin-blue-light.less"
                }
            }
        },
        ...
        uglify: {
            ...
            my_target: {
                files: {
                    ...
                    '../Linko.LinkoExchange.Web/scripts/AdminLTE/app.min.js': ['../Linko.LinkoExchange.Web/scripts/AdminLTE/app.js']
                }
            }
        },
        ...
        csslint: {
            ...
            dist: [
              ...
              '../Linko.LinkoExchange.Web/Content/AdminLTE/css/AdminLTE.css'
            ]
        },
    ...
    // Copy JS and create css file from less and minified all
    grunt.registerTask('all', ['less', 'copy', 'uglify']);
